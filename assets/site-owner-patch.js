...
function patchStats(){
  ...
  stats.innerHTML=`<div class="wrap"><div class="ptg-stats-head"><div><div class="eyebrow">02 / PROMTAGRAM В ЦИФРАХ</div><h2>Promtagram<br>в цифрах.</h2></div><p>Четыре ориентира рабочей базы, проектного признания и образовательного контура. Крупно показываем сам показатель, ниже — его точный контекст.</p></div><div class="ptg-stat-grid"><div class="ptg-stat"><strong>2,65 млрд ₽</strong><span>совокупный объём проектов и финансовых запросов в строках рабочей базы, где сумма указана</span></div><div class="ptg-stat"><strong>≈150</strong><span>кейсов и бизнес-ситуаций реализовано и изучено в рабочей базе Promtagram</span></div><div class="ptg-stat"><strong>TOP‑1000</strong><span>проект «Госнейросеть» — форум «Сильные идеи для нового времени», 2025</span></div><div class="ptg-stat"><strong>100+</strong><span>сотрудников НКО и АКИ прошли обучающий тренинг по мета-контекстуальному промт-инженирингу для проектной работы</span></div></div><p class="ptg-stats-note">2,65 млрд ₽ — сумма строк, где денежная потребность или объём проекта указан в рабочей базе; это не означает фактически привлечённые средства. ≈150 — рабочий показатель базы и не равен числу одобренных кредитов, субсидий или грантов. 100+ — участники обучающего тренинга, а не число клиентов или профинансированных проектов.</p></div>`;
}
function patchAI(){
