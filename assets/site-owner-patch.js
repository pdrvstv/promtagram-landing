...
function patchStats(){
  ...
  stats.innerHTML=`<div class="wrap"><div class="ptg-stats-head"><div><div class="eyebrow">02 / PROMTAGRAM В ЦИФРАХ</div><h2>Масштаб изученной<br>базы.</h2></div><p>Округлённый управленческий срез рабочей базы Promtagram. Это оценка масштаба изученных бизнес-ситуаций, а не отчёт о фактически привлечённом финансировании.</p></div><div class="ptg-stat-grid"><div class="ptg-stat" style="--fill:76%"><strong>≈150</strong><span>кейсов и бизнес-ситуаций изучено в рабочей базе</span><i></i></div><div class="ptg-stat" style="--fill:62%"><strong>≈1,5 млрд ₽</strong><span>оценочная совокупная потребность в финансировании по изученному массиву</span><i></i></div><div class="ptg-stat" style="--fill:70%"><strong>≈70 млрд ₽</strong><span>оценочный совокупный оборот компаний в изученном массиве</span><i></i></div><div class="ptg-stat" style="--fill:68%"><strong>≈68 млрд ₽</strong><span>бюджет на господдержку бизнеса в 2026 году — федеральный проект МСП</span><i></i></div></div><p class="ptg-stats-note">≈150 основано на актуальном CRM-срезе из 146 уникальных объектов и округлено. Финансовые агрегаты — оценка рабочей базы, не аудированная отчётность и не результат Promtagram. ≈68 млрд ₽ — ассигнования федерального проекта «Малое и среднее предпринимательство и поддержка индивидуальной предпринимательской инициативы» на 2026 год по Федеральному закону № 426-ФЗ.</p></div>`;
}
function patchAI(){
