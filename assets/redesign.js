...
/*
  IMPORTANT: the homepage is now single-source.
  Do not dynamically load historical homepage mutators here.
  They are kept only for non-home legacy pages that may still depend on them.
*/
